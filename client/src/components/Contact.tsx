...
export default function Contact() {
  ...
  return (
    <section id="contact" className="pt-24 pb-12 bg-card rounded-t-[40px] md:rounded-t-[80px] shadow-[0_-20px_50px_rgba(0,0,0,0.1)] relative mt-20 border-t border-border/20 z-30">
      <div className="container mx-auto px-6 flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6 mt-16 w-full max-w-5xl">
          ...
          <a href="mailto:sid143pk@gmail.com" className="flex items-center gap-4 bg-background/40 hover:bg-background border border-border/60 rounded-full px-6 py-4 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
          ...
          <a href="https://linkedin.com/in/praveen-kashyap-323719251" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-background/40 hover:bg-background border border-border/60 rounded-full px-6 py-4 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
            <div className="flex items-center justify-center w-8 h-8 rounded-full border border-foreground/20">
          ...
          <a href="tel:+919795264544" className="flex items-center gap-4 bg-background/40 hover:bg-background border border-border/60 rounded-full px-6 py-4 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1">
            <div className="flex items-center justify-center w-8 h-8 rounded-full border border-foreground/20">
          ...
          <div className="flex items-center gap-4 bg-background/40 hover:bg-background border border-border/60 rounded-full px-6 py-4 transition-all duration-300 shadow-sm hover:-translate-y-1 cursor-default">
        ...
        <div className="mt-28 pt-8 w-full text-center relative">
          ...
          <p className="text-foreground/40 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase pt-4">
            © {currentYear} PRAVEEN KASHYAP . YMCA UNIVERSITY OF SCIENCE & TECHNOLOGY
          </p>
        </div>
